    ...
    <div class="col-md-10 col-sm-10">
     ...
     <div class="body">
      ...
      <div class="canvass-tabs canvass-tabs-pos-right canvass-tabs-anim-flip canvass-tabs-response-to-icons">
        ...
        <label for="canvass-tab1"><span><span><i class="fa fa-bars"></i>Descrizione Progetto</span></span></label>
        
        <input type="radio" name="canvass-tabs" id="canvass-tab2" class="canvass-tab-content-2">
        <label for="canvass-tab2"><span><span><i class="fa fa-euro"></i>Costi & Risorse</span></span></label>
        
        <input type="radio" name="canvass-tabs" id="canvass-tab3" class="canvass-tab-content-3">
        <label for="canvass-tab3"><span><span><i class="fa fa-refresh"></i>Replicabilità</span></span></label>
        ...
        <input type="radio" name="canvass-tabs" id="canvass-tab5" class="canvass-tab-content-5">
        <label for="canvass-tab5"><span><span><i class="fa fa-search"></i>Interessati ? </span></span></label>

        <input type="radio" name="canvass-tabs" id="canvass-tab6" class="canvass-tab-content-6">
        <label for="canvass-tab6"><span><span><i class="fa fa-edit"></i>Modifica Idea</span></span></label>
        ...
        <ul>
          <li class="canvass-tab-content-1">          
            <div class="typography">
              ...
              <h4>Fasi del progetto</h4>
               <p>Tesla started working in the telephony and electrical fields before emigrating to the United States in 1884 to work for Thomas Edison. He soon struck out on his own with financial backers, setting up laboratories/companies to develop a range of electrical devices. His patented AC induction motor and transformer were licensed by George Westinghouse, who also hired Tesla as a consultant to help develop an alternating current system. Tesla is also known for his high-voltage, high-frequency power experiments in New York and Colorado Springs which included patented devices and theoretical work used in the invention of radio communication, for his X-ray experiments, and for his ill-fated attempt at intercontinental wireless transmission in his unfinished Wardenclyffe Tower project.</p>
               <h4>Link di riferimento</h4>
               <p><a href="#">www.sito.it</a></p>
               <p><a href="#">www.google.it</a></p>
            </div>
          </li>
          ...
          <li class="canvass-tab-content-2">
            <div class="typography">
              <h1>Costi & Risorse</h1>
              <h4>Costo complessivo del progetto</h4>
              <p>Italian Renaissance polymath: painter, sculptor, architect, musician, mathematician, engineer, inventor, anatomist, geologist, cartographer, botanist, and writer. His genius, perhaps more than that of any other figure, epitomized the Renaissance humanist ideal.</p>
              <h4>Note informazioni economiche</h4>
              <p> Leonardo has often been described as the archetype of the Renaissance Man, a man of "unquenchable curiosity" and "feverishly inventive imagination". He is widely considered to be one of the greatest painters of all time and perhaps the most diversely talented person ever to have lived. According to art historian Helen Gardner, the scope and depth of his interests were without precedent and "his mind and personality seem to us superhuman, the man himself mysterious and remote". Marco Rosci states that while there is much speculation about Leonardo, his vision of the world is essentially logical rather than mysterious, and that the empirical methods he employed were unusual for his time.</p>
              <h4>Fonti di finanziamento di natura pubblica</h4>
              <p><input type="checkbox"> Fondi strutturali</p>
              <p><input type="checkbox"> Fondi nazionali</p>
              <p><input type="checkbox">Fondi regionali non strutturali </p>
              <p><input type="checkbox"> Fondi città metropolitana</p>
              <p><input type="checkbox"> Fondi comunali</p>
              <p><input type="checkbox"> Risorse UE a gestione diretta</p>
              <h4>Fonti di finanziamento di natura privata</h4>
              <p><input type="checkbox"> Fondi privati</p>
              <p><input type="checkbox"> Crowdfunding</p>
              <p><input type="checkbox"> Minibond</p>
              <p><input type="checkbox"> Donazioni<p>
              <p><input type="checkbox"> Finanziamento</p>
              <p><input type="checkbox"> Mutuo</p>
            </div>
          </li>
          ...
          <li class="canvass-tab-content-3">
            <div class="typography">
              <h1>Replicabilità</h1>
              <h4>Possesso dei diritti di proprietà intellettuale</h4>
              <p>Si</p>  
          ...
          <li class="canvass-tab-content-5">
            <div class="typography">
              <h1>Isaac Newton</h1>
          ...
          <li class="canvass-tab-content-6">
            <div class="typography">
              <h1>Isaac Newton</h1>
              <p>English physicist and mathematician who is widely regarded as one of the most influential scientists of all time and as a key figure in the scientific revolution. His book Philosophiæ Naturalis Principia Mathematica ("Mathematical Principles of Natural Philosophy"), first published in 1687, laid the foundations for most of classical mechanics. Newton also made seminal contributions to optics and shares credit with Gottfried Leibniz for the invention of the infinitesimal calculus.</p>
              <p>Newton's Principia formulated the laws of motion and universal gravitation that dominated scientists' view of the physical universe for the next three centuries. It also demonstrated that the motion of objects on the Earth and that of celestial bodies could be described by the same principles. By deriving Kepler's laws of planetary motion from his mathematical description of gravity, Newton removed the last doubts about the validity of the heliocentric model of the cosmos.</p>
