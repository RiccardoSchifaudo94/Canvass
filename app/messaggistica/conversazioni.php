      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="box box-solid">
            <div class="box-header with-border">
              <h3 class="box-title">Conversazioni</h3>
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="canvass-post-category">Conversazioni<i class="fa fa-comments-o"></i>
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td align="center"><form action="apri-conversazione.php" method="post"><button class="btn btn-flat btn-info"><i class="fa fa-comments-o"></i></button></form></td>
                  </tr>
                  <tr>
                    <td><input type="checkbox"></td>
                    <td class="mailbox-name"><a href="leggi.php">Alexander Pierce</a></td>
