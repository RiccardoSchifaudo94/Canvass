      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="box box-primary">
             <div class="canvass-post-category">Leggi<i class="fa fa-eye"></i></div>      
            <!-- /.box-header -->
            <div class="box-body no-padding">
              <div class="mailbox-read-info">
                <h3>Nessun Oggetto Messaggio</h3>
            ...
            <div class="box-footer no-padding">
              <ul class="mailbox-attachments clearfix">
                ...
                <li>
                  <span class="mailbox-attachment-icon has-img"><img src="../../img/ricky.jpg" alt="Attachment"></span>
            ...
            <div class="box-footer">
              <div class="pull-right">
                <form action="rispondi.php" method="POST"><button type="submit" class="btn btn-primary"><i class="fa fa-reply"></i> Rispondi</button></form>
              </div>
